package com.myandroid.wzh.utilscollections.ToastUtil;
...
public class ToastUtils {
     ...
     * @param message 显示文本
     */
    public static void toastShortShow(final Context context, final String message) {
        if (toast == null) {
     ...
     * @param message 显示文本
     */
    public static void toastLongtShow(final Context context, final String message) {
        if (toast == null) {
    ...
    public static void ToastShortCenterLeft(Context context, String message) {
        if (context != null) {
            ...
            toast.setGravity(Gravity.CENTER | Gravity.LEFT,
                    0,
                    0);
            toast.show();
        }
    ...
    public static void ToastShortCenterRight(Context context, String message) {
        if (context != null) {
            ...
            toast.setGravity(Gravity.CENTER | Gravity.RIGHT,
                    0,
                    0);
            toast.show();
        }
