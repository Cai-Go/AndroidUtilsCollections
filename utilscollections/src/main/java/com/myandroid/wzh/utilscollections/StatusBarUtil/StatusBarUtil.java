package com.myandroid.wzh.utilscollections.StatusBarUtil;
 ...
 * @author W.Z.H
 * @time 2018/6/6 11:20
 * @description 状态栏工具类（实现沉浸式状态栏/变色状态栏）
 * <p>
 * from  https://jaeger.itscoder.com/android/2016/03/27/statusbar-util.html
